          ...
          <div className="prose prose-slate max-w-none relative z-10">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-slate-700 leading-relaxed bg-slate-50/50 p-8 rounded-2xl border border-slate-100">
                <div>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">{t('party_a')}</p>
                  <p className="font-bold text-lg">{data.parties?.split(' en ')[0] || '...'}</p>
                </div>
                <div>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">{t('party_b')}</p>
            ...
            <div className="grid grid-cols-2 gap-16 mt-32">
              <div className="border-t-2 border-slate-900 pt-8 text-center relative">
                ...
                <p className="text-[10px] font-black text-slate-400 mb-12 uppercase tracking-[0.3em]">{t('sign_party_a')}</p>
                ...
                {hasSigned ? (
                  <div className="animate-in fade-in zoom-in duration-500">
                    ...
                    <p className="text-[10px] text-slate-300 font-bold">{t('ref')} RS-{Math.random().toString(36).substr(2, 6).toUpperCase()}</p>
                    <p className="text-[9px] text-slate-400 mt-1">{t('date')} {data.date}</p>
                  </div>
                ) : (
              ...
              <div className="border-t-2 border-slate-200 pt-8 text-center">
                <p className="text-[10px] font-black text-slate-400 mb-12 uppercase tracking-[0.3em]">{t('sign_party_b')}</p>
                <div className="h-10 mb-2 flex items-center justify-center">
                  <span className="text-[10px] text-slate-300 italic font-medium uppercase tracking-widest animate-pulse">{t('waiting_sign')}</span>
                </div>
              </div>
            </div>
          </div>
