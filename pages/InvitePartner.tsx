...
const InvitePartner: React.FC<InvitePartnerProps> = ({ onComplete }) => {
  ...
  const inviteLink = `https://rsolve.app/#/invite/${btoa(formData.title || "dossier").substring(0, 8)}`;
      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-500">
        ...
        {!showInvite ? (
          <div className="space-y-8 text-center">
            <div className="inline-flex w-20 h-20 bg-emerald-500 rounded-[32px] items-center justify-center shadow-2xl mb-2">
            ...
            <Card className="p-8 space-y-6 bg-white border-none shadow-2xl rounded-[32px]">
               <div className="space-y-4">
                  <Button 
                    ...
                    className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-6 rounded-2xl font-black flex items-center justify-center gap-4 transition-all shadow-xl shadow-emerald-100 active:scale-95 animate-pulse-subtle"
                  >
