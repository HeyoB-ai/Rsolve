    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 overflow-hidden">
      <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-700">
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-500 font-medium px-4">Je mediation dossier is betaald en klaar voor gebruik. De tegenpartij moet nu deelnemen via deze unieke link.</p>
        </div>
        ...
        <Card className="p-8 space-y-8 bg-white border-none shadow-2xl rounded-[32px]">
           <div className="space-y-6">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-[10px] uppercase tracking-[0.3em] font-black text-slate-300"><span className="bg-white px-3">Of deel handmatig</span></div>
              </div>
              ...
              >
                ...
                <span className={`text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-lg ${hasCopied ? 'bg-emerald-500 text-white' : 'bg-slate-200 text-slate-600'}`}>
                  {hasCopied ? 'Kopieer' : 'Kopieer'}
                </span>
              </div>
           </div>

           <div className="space-y-3 pt-2 text-center">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Je kunt nu ook alvast je dossier bekijken</p>
           </div>
        </Card>
        ...
        <Button 
          variant="primary" 
          size="lg" 
          className="w-full rounded-2xl py-5 shadow-xl"
