...
/**
 * Rsolve Official Logo: A minimalist circle with a vertical line, 
 * symbolizing balance, mediation, and a clear path forward.
 */
export const Logo: React.FC<LogoProps> = ({ className = "w-8 h-8", showText = false }) => {
  return (
    <div className="flex items-center gap-3 group select-none">
      <div className={`text-primary shrink-0 transition-all duration-500 group-hover:rotate-12 ${className}`}>
